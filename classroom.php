        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="classroom.php" class="nav-item nav-link active"><i
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">เพิ่มชั้นเรียน</h6>
                            <form action="classroom/add_classroom.php" method="post">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="sublevel" id="level"
                                        aria-label="Floating label select example">
                                    ...
                                    <span class="input-group-text">-</span>
                                    <input type="text" class="form-control" placeholder="ห้องเช่น 1 1/3 ห้องดอกไม้"
                                        name="class" autocomplete="off" required>

                                </div>
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="line token" name="line_token"
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">เพิ่มแผนก</h6>
                            <form action="classroom/add_department.php" method="post"
                                onsubmit="return validateForm2();">
                                <div class="mb-3">
                                    <label class="form-label">ชื่อแผนก</label>
                                    <input type="text" class="form-control" placeholder="ชื่อแผนก" name="name"
                                        autocomplete="off" required>
                                </div>
                                <button type="submit" class="btn btn-primary">บันทึก</button>
                            </form>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function populateTable(dataArray) {
                var tableBody = $('#myTable tbody'); // เพิ่มการเชื่อมโยงไปยัง tbody ของตาราง
                tableBody.empty(); // เคลียร์ข้อมูลในตารางก่อนเพิ่มข้อมูลใหม่

                dataArray.forEach(function (item) {
                    var tableRow = $('<tr></tr>');
                    tableRow.append($('<td></td>').text(item.level + " " + item.sublevel));
                    tableRow.append($('<td></td>').text(item.class));
                    tableRow.append($('<td></td>').text(item.line_token));
                    var deleteLink = $("<a></a>").addClass('btn btn-sm btn-primary').attr('href', 'classroom/del_classroom.php?id=' + item.id).text('ลบ');
